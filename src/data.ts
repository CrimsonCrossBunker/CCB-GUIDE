...
const fetchJson = async (
  ...
  return fetchJsonWithProgress(
    `https://raw.githubusercontent.com/CrimsonCrossBunker/CCB-GUIDE-DATA/main/data/${version}/all.json`,
    progress,
  );
};
...
const fetchLocaleJson = async (
  ...
  return fetchJsonWithProgress(
    `https://raw.githubusercontent.com/CrimsonCrossBunker/CCB-GUIDE-DATA/main/data/${version}/lang/${locale}.json`,
    progress,
  );
};
