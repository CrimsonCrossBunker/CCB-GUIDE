...
const dataUrl = update
  ? "https://raw.githubusercontent.com/CrimsonCrossBunker/CCB-GUIDE-DATA/main/data/latest/all.json"
  : `https://raw.githubusercontent.com/nornagon/cdda-data/main/data/${buildNum}/all.json`;
